...
install_vanilla_i3() {
    ...
    bash ~/trixie-scripts/install_scripts/vanilla_i3.sh
}

# Function to install customized i3
install_custom_i3() {
    echo "Installing customized i3..."
    bash ~/trixie-scripts/install_scripts/custom_i3.sh
}
